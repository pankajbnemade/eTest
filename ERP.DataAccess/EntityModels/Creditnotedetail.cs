...
namespace ERP.DataAccess.EntityModels
{
    ...
    public partial class Creditnotedetail
    {
        ...
        [InverseProperty(nameof(Creditnote.Creditnotedetails))]
        public virtual Creditnote CreditNote { get; set; }
        [ForeignKey(nameof(PreparedByUserId))]
        [InverseProperty(nameof(Aspnetuser.CreditnotedetailPreparedByUsers))]
        public virtual Aspnetuser PreparedByUser { get; set; }
        [ForeignKey(nameof(UnitOfMeasurementId))]
        [InverseProperty(nameof(Unitofmeasurement.Creditnotedetails))]
        public virtual Unitofmeasurement UnitOfMeasurement { get; set; }
        [ForeignKey(nameof(UpdatedByUserId))]
        [InverseProperty(nameof(Aspnetuser.CreditnotedetailUpdatedByUsers))]
        public virtual Aspnetuser UpdatedByUser { get; set; }
        [InverseProperty(nameof(Creditnotedetailtax.CreditNoteDet))]
