...
{
    [Table("debitnotetax")]
    public partial class Debitnotetax
    {
        [Key]
        ...
        [InverseProperty(nameof(Debitnote.Debitnotetaxes))]
        public virtual Debitnote DebitNote { get; set; }
        [ForeignKey(nameof(PreparedByUserId))]
        [InverseProperty(nameof(Aspnetuser.DebitnotetaxPreparedByUsers))]
        public virtual Aspnetuser PreparedByUser { get; set; }
        [ForeignKey(nameof(TaxLedgerId))]
        [InverseProperty(nameof(Ledger.Debitnotetaxes))]
        public virtual Ledger TaxLedger { get; set; }
        [ForeignKey(nameof(UpdatedByUserId))]
        [InverseProperty(nameof(Aspnetuser.DebitnotetaxUpdatedByUsers))]
