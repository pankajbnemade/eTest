...
{
    [Table("creditnotetax")]
    public partial class Creditnotetax
    {
        [Key]
        ...
        [InverseProperty(nameof(Creditnote.Creditnotetaxes))]
        public virtual Creditnote CreditNote { get; set; }
        [ForeignKey(nameof(PreparedByUserId))]
        [InverseProperty(nameof(Aspnetuser.CreditnotetaxPreparedByUsers))]
        public virtual Aspnetuser PreparedByUser { get; set; }
        [ForeignKey(nameof(TaxLedgerId))]
        [InverseProperty(nameof(Ledger.Creditnotetaxes))]
        public virtual Ledger TaxLedger { get; set; }
        [ForeignKey(nameof(UpdatedByUserId))]
        [InverseProperty(nameof(Aspnetuser.CreditnotetaxUpdatedByUsers))]
